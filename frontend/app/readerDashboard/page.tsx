...
import { Home, BookOpen, Heart, BarChart2, MessageSquare,  User, LogOut, Menu, X } from 'lucide-react';
            ...
            <div className="flex items-center gap-3">
               ...
               {isSidebarOpen && (
                 <div className="overflow-hidden">
                   ...
                   <p className="text-[10px] text-gray-800 truncate">{user?.email}</p>
                 </div>
               )}
            </div>
            <button onClick={logOut} className={`flex items-center gap-2 bg-red-500 text-white px-4 py-2 rounded-lg text-sm w-32 transition-all ${!isSidebarOpen && 'hidden '}`}>
              <LogOut size={18} />
